...
def ensure_cli_args(args: List) -> List:
    ...
    if "--save-tests" in args:
        logger.warning(
            f"generate cctest1.py keep compatibility with --save-tests in v2"
        )
...
'''
    ...
    conftest_path = os.path.join(project_root_dir, "cctest1.py")

    test_path = os.path.abspath(test_path)
    logs_dir_path = os.path.join(project_root_dir, "log")
    ...
    logger.info("generated cctest1.py to generate summary.json")
